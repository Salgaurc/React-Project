...
useEffect(() => {
    ...
    filtered = filtered.filter((flat) => {
        ...
        const minPrice = priceRange.min !== "" ? Number(priceRange.min) : -Infinity;
...
}, [flats, cityFilter, priceRange, areaRange, showFavorites, favorites, sortOption]);
            ...
            <div className={styles.filtersMainContainer}>
                <div className={styles.filtersSubContainer}>
                    ...
                    <div className={styles.resetBtnContainer}>
                         <button className={styles.resetFilter} onClick={handleResetAllFilters}>X</button>
                    </div>
                    <div>
            ...
            <div className={styles.cardContainer}>
                {filteredFlats.length > 0 ? (
                    filteredFlats.map((flat) => (
                        ...
                        >
                            {flat.imageUrl && (
                                <img className={styles.image} src={flat.imageUrl} alt={flat.name} />
                            )}
